...
#É um array onde cada elemento é um array de duas posições, na posição [0] é o nome da variável no python e 
...
def format_for_fortran(data_array):
       formated_data = []
...
def save_step_values_to_txt(step_array, step):
       formated_for_fortran = format_for_fortran(step_array)
